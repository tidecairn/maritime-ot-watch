...
json.loads((D/'data/watch.json').read_text(encoding='utf-8'))
expected=(D/'data/watch.sha256').read_text(encoding='utf-8').split()[0]; actual=hashlib.sha256((D/'data/watch.json').read_bytes()).hexdigest(); assert expected==actual
